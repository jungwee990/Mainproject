//import { MaterialLoader } from "./libs/MaterialLoader";
...
class Game {
	...
	init() {
		...
		//const controls = new OibitControls(camera, renderer.domElement);//삭제
		...
		loader.load(`${this.assetsPath}fbx/polygonoffice3.fbx`, function (polygonoffice3) {
			polygonoffice3.position.set(-1000, 350, -7500);  
	...
	animate() {
		...
		this.updateRemotePlayers(dt);//화면 새로 고침에서 길을 잃은 후 경과된 델타 시간 내에
		// 플레이어 초기화와 플레이어 이동을 처리해야 합니다.
